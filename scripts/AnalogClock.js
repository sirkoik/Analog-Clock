...
class AnalogClock {
    ...
    constructor(args) {
        ...
        this.clockMath = new ClockMath(args);
        ...
        // randomize parameters onclick and save
        document.onclick = () => {
            this.setNumbersRand();
            this.setColorsRand();
            this.setDDRand();
    ...
    setTime() {
        ...
        document.querySelector('.hand-second').style.transform = 'rotate('+t.secRotation+'deg)';
